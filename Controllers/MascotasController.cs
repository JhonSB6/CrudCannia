...
namespace CrudCannia.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMascota,Nombre,Especie,Raza,Edad,Sexo")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMascota,Nombre,Especie,Raza,Edad,Sexo")] Mascota mascota)
        {
